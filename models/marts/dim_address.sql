...
, final_address as (
    ...
    from
        address_city
    left join
        state_province on address_city.stateprovince_id = state_province.stateprovince_id
    left join
        country_region on state_province.countryregion_code = country_region.countryregion_code
)
